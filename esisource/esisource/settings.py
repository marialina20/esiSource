"""
Django settings for esisource project.
...
SECRET_KEY = 'django-insecure-ulb!v_ejld1xb%r(izvz#m*rs$#u1ju-i)vu-0evdxom6!u^=z'
...
WSGI_APPLICATION = 'esisource.wsgi.application'
